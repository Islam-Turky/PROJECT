...
const Home = () => {
  ...
  return(
    <Box>
        ...
        {/* brands */}
        <Box className='mainContainer' sx={{ padding:0, margin: 0, marginTop: '10px' }} id="brands" >
            <Slider {...setting} className='slider'>
                <div className="container">
                    <a href="/samsung" target="blank">
                ...
                <div className="container">
                    <a href="/kiriazi" target="blank" >
                        <img src="/kiriazi.png" alt="kiriazi" />
                    </a>
                </div>
                <div className="container">
                    <a href="/white" target="blank">
                        <img src="/white.jpg" alt="whitewhale" />
                    </a>
                </div>
                <div className="container">
                    <a href="/lg" target="blank">
